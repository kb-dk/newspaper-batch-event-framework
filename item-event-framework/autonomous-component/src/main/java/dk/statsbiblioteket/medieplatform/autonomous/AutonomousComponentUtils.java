    ...
    public static <T extends Item> CallResult<T> startAutonomousComponent(Properties properties, RunnableComponent<T> component,
        ...
        try {
            ...
            AutonomousComponent<T> autonoumous = new AutonomousComponent<>(component,
                    ...
                    toEvents(properties.getProperty(ConfigConstants.AUTONOMOUS_UP2DATE_EVENTS)),
                    toEvents(properties.getProperty(ConfigConstants.AUTONOMOUS_OUTDATED_EVENTS)),
                    toEvents(properties.getProperty(ConfigConstants.AUTONOMOUS_OUTDATED_OR_MISSING_EVENTS)),
