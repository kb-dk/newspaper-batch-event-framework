...
public class VirtualIteratorForFileSystems extends CommonTransformingIterator {
    ...
    public VirtualIteratorForFileSystems(File id, String prefix, File batchFolder, String dataFilePattern,
                                         List<File> group, String groupingChar, String checksumPostfix) {
        ...
        for (File dataFile : datafiles) {
            ...
            virtualChildren.add(
                    new DatafileIterator(
                            dataFile, getBatchFolder(), getChecksumPostfix(), getGroupingChar()));
        }
