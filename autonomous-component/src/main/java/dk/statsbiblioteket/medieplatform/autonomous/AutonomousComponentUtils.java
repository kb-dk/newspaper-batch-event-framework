...
public class AutonomousComponentUtils {
     ...
     */
    public static Map<String, Boolean> startAutonomousComponent(Properties properties, RunnableComponent component) {
        ...
        long maxRunTimeForWorker = Long.parseLong(
                properties.getProperty(
                        ConfigConstants.AUTONOMOUS_MAX_RUNTIME,
                        60 * 60 * 1000l + ""));
        ...
        try {//Start the component
            ...
            System.err
                  .println("Failed to communicate with the backend systems. The work done is lost.");
    ...
    public static void printResults(Map<String, Boolean> result) {
        ...
        for (Map.Entry<String, Boolean> stringBooleanEntry : result.entrySet()) {
            if (stringBooleanEntry.getValue()) {
                System.out
                      .println("Worked on " + stringBooleanEntry.getKey() + " successfully");
            } else {
                System.out
                      .println("Failed to process " + stringBooleanEntry.getKey());
            }
